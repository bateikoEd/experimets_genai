...
# 4) A few labeled examples (tiny train/dev)
trainset = [
    dict(text="Jane Roe <jroe@ex.io> 22 Pine Ave, Boston, MA 02110", 
         json_out='{"name":"Jane Roe","email":"jroe@ex.io","phone":null,"address":{"street":"22 Pine Ave","city":"Boston","state":"MA","zip":"02110"},"tags":[]}'),
    dict(text="Vendor ACME UK; contact bob@acme.co.uk, +44 20 7946 0101; 221B Baker St, London", 
         json_out='{"name":"ACME UK","email":"bob@acme.co.uk","phone":"+44 20 7946 0101","address":{"street":"221B Baker St","city":"London","state":null,"zip":null},"tags":["vendor"]}'),
]
devset = [
    dict(text="J. Smith, 10 Main St, Denver CO 80202, phone 303-555-0123; js@smith.io",
         json_out='{"name":"J. Smith","email":"js@smith.io","phone":"303-555-0123","address":{"street":"10 Main St","city":"Denver","state":"CO","zip":"80202"},"tags":[]}')
]
